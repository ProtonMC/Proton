...
/**
 * A module that adds a tiny potato (tater).
 *
 * @author TehcJS
 * @author mounderfod
 */
...
public class TaterModule extends ProtonModule {
    ...
    public void commonInit() {
        ...
        ProtonRegisterHandler.block("fat_potato", fatPotatoBlock, new Item.Settings().group(ItemGroup.DECORATIONS));
    ...
    public void registerResources(ResourceHandler resourceHandler) {
        ...
        resourceHandler.pack.addBlockState(identifier(base), blockStateBuilder -> {
            blockStateBuilder.variant("facing=south", variant -> variant.model(identifier("block/" + base)))
